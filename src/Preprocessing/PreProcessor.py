...
def create_sentence_context_list(json_file_path: str) -> List[tuple[str, Dict[str, str]]]:
...
def create_point_context_map(sentence_list: List[tuple[str, Dict[str, str]]]) -> Dict[str, Dict[str, str]]:
